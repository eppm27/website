...
const Footer = () => {
  ...
  return (
    <footer
      className={`${isDark ? "bg-[#0b1020]" : "bg-slate-100"} text-slate-300`}
    >
      <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-16">
        <div className="grid gap-10 text-center sm:text-left lg:grid-cols-[1.15fr_0.95fr_0.9fr]">
          <div className="flex flex-col items-center sm:items-start">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs uppercase tracking-[0.32em] text-[#60a5ff]">
                  Ei Phyu Phyu Mon
                </p>
            ...
            <p className="mt-6 max-w-md text-sm text-slate-400">
              Sydney-based, building performant full-stack experiences with
              React, Next.js, Node/FastAPI, and PostgreSQL. Open to software
          ...
          <div className="flex flex-col items-center sm:items-start">
            <h3 className="text-sm font-semibold uppercase tracking-[0.32em] text-[#60a5ff]">
              Navigate
            </h3>
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <p className="mt-4 text-sm text-slate-400">
              Sydney, Australia · Available for internships
            </p>
            <p className="mt-2 text-sm text-slate-500">
              Timezone: AEST · Remote-friendly
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 flex flex-col items-center gap-3 border-t border-slate-800 pt-6 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between">
          <span className="text-center sm:text-left">
            © {year} Ei Phyu Phyu Mon. Crafted with care and curiosity.
          </span>
