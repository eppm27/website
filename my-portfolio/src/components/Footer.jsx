  ...
  return (
    <footer className="bg-slate-900 text-slate-300">
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-16">
        <div className="grid gap-10 text-center sm:text-left lg:grid-cols-[1.2fr_1fr_1fr]">
          <div className="flex flex-col items-center sm:items-start">
            ...
            <p className="mt-6 max-w-md text-sm text-slate-400 text-center sm:text-left">
        ...
        <div className="mt-12 flex flex-col items-center gap-3 border-t border-slate-800 pt-6 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between">
          <span className="text-center sm:text-left">© {year} Ei Phyu Phyu Mon. Crafted with curiosity and care.</span>
