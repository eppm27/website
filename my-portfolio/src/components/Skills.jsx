...
const buildCategories = () => ({
  frontend: {
    ...
    description:
      "Modern frameworks and tools for building responsive, accessible user interfaces.",
    skills: [
      {
  ...
  backend: {
    title: "Backend & APIs",
    description:
      "Server-side technologies for building scalable, robust applications and APIs.",
    skills: [
      {
      ...
      },
      {
        ...
        icon: <img src="/svg/api.svg" alt="API" className="w-8 h-8" />,
      },
      {
        name: "Microservices Architecture",
        icon: (
          <img
            src="/svg/architecture.svg"
            alt="Architecture"
            className="w-8 h-8"
          />
        ),
  ...
  databases: {
    ...
    description:
      "Relational and NoSQL databases with modern ORMs for efficient data management.",
    skills: [
      {
      ...
      {
        name: "MongoDB (NoSQL)",
        icon: <img src="/svg/mongodb.svg" alt="MongoDB" className="w-8 h-8" />,
      },
      {
  ...
  devops: {
    title: "DevOps & Tools",
    description:
      "Development tools and practices for efficient deployment and collaboration.",
    skills: [
      {
      ...
      },
      {
        ...
        icon: (
          <svg className="w-8 h-8" viewBox="0 0 832 832" fill="none">
            <path
              d="M605.569 208H405.773C405.773 231.92 415.276 254.861 432.19 271.775C449.104 288.689 472.044 298.191 495.964 298.191H532.769V333.724C532.801 383.491 573.136 423.826 622.902 423.858V225.333C622.902 215.76 615.142 208 605.569 208Z"
              fill="#2684FF"
            />
            <path
              d="M506.711 307.551H306.916C306.947 357.317 347.283 397.653 397.049 397.684H433.853V433.333C433.917 483.099 474.278 523.409 524.044 523.409V324.884C524.044 315.312 516.284 307.551 506.711 307.551Z"
              fill="url(#paint0_linear_jira)"
            />
            <path
              d="M407.796 407.044H208C208 456.856 248.38 497.236 298.191 497.236H335.111V532.769C335.143 582.49 375.408 622.807 425.129 622.902V424.378C425.129 414.805 417.368 407.044 407.796 407.044Z"
              fill="url(#paint1_linear_jira)"
            />
            <defs>
              <linearGradient
                id="paint0_linear_jira"
                x1="475.686"
                y1="265.651"
                x2="391.212"
                y2="353.796"
      ...
      },
      {
        ...
        icon: <img src="/svg/postman.svg" alt="Postman" className="w-8 h-8" />,
      },
      {
    ...
    <section id="skills" className="py-20 md:py-28">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
        <div className="text-center">
          ...
          >
            Comprehensive tech stack spanning frontend development, backend
            APIs, databases, and DevOps tools for building scalable applications
            in FinTech, AI, and biomedical domains.
          </p>
        </div>
          ...
          >
            ...
            <div className="mt-8 grid gap-4">
              {categoryConfig[selectedCategory].skills.map((skill) => (
                <div
                  key={skill.name}
                  className="flex items-center p-4 bg-gray-800/50 rounded-lg border border-gray-700/50 hover:border-gray-600/50 transition-all duration-300 hover:bg-gray-800/70"
                >
